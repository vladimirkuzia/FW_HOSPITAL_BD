...
*Некоторые действия могут вызвать ошибку, такие как: неверный логин/пароль, запись мужчины к врачу-гинекологу, запись на время, где уже стоит другая запись.*
...
*add_patient* -  добавление в таблицу patient пациента
...
*update_patient_age* – по полю даты рождения запишет чколько лет пациенту
